...
const SalaryIncome = () => {
  ...
  const fetchSalaryHistory = async () => {
    ...
    try {
      ...
      const lengthRaw = await contract.methods
        .getSalaryHistoryLength(web3State.account)
        .call();
      ...
      console.error("Failed to fetch salary income history:", error);
      toast.error("Failed to fetch salary income history");
      setHistory([]);
    } finally {
      setIsLoading(false);
    }
  ...
  return (
    <div className="app-wrapper SalaryIncomePage">
      <Sidebar />
              ...
              {!web3State.isConnected && (
                <div className="col-12">
                  <div className="alert alert-warning d-flex justify-content-between align-items-center">
                    <span>Please connect your wallet to view salary income.</span>
                    <button
                      className="btn btn-sm btn-primary"
